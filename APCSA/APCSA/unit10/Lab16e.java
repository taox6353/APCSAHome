...
public class Lab16e
{
	...
	{
		Histogram test1 = new Histogram(new char[]{'a','b','c'},"APCSA\\unit10\\lab16e1.dat");
		...
		//more test cases
		Histogram test2 = new Histogram(new char[]{'d','e','a'},"APCSA\\unit10\\lab16e2.dat");
		...
		Histogram test3 = new Histogram(new char[]{'x','a','r','g'},"APCSA\\unit10\\lab16e3.dat");
